    ...
    E.createConversation
      NewConversation
        { ncType = RegularConv,
          ...
          ncAccessRole = accessRoleLegacy body,
          ncName = name,
...
createTeamGroupConv lusr zcon tinfo body = do
  ...
  ensureAccessRole (accessRoleLegacy body) (zip (ulLocals allUsers) convLocalMemberships)
...
accessRoleLegacy :: NewConv -> Set AccessRoleV2
accessRoleLegacy b = fromMaybe Data.defRole (newConvAccessRoles b)
