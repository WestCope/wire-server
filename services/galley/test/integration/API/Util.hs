...
createTeamConvAccess :: HasCallStack => UserId -> TeamId -> [UserId] -> Maybe Text -> Maybe (Set Access) -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> Maybe RoleName -> TestM ConvId
...
createTeamConvAccessRaw :: UserId -> TeamId -> [UserId] -> Maybe Text -> Maybe (Set Access) -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> Maybe RoleName -> TestM ResponseLBS
...
postConv :: UserId -> [UserId] -> Maybe Text -> [Access] -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> TestM ResponseLBS
...
postTeamConv :: TeamId -> UserId -> [UserId] -> Maybe Text -> [Access] -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> TestM ResponseLBS
...
postConvWithRole :: UserId -> [UserId] -> Maybe Text -> [Access] -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> RoleName -> TestM ResponseLBS
...
postConvWithReceipt :: UserId -> [UserId] -> Maybe Text -> [Access] -> Maybe AccessRoleLegacy -> Maybe Milliseconds -> ReceiptMode -> TestM ResponseLBS
...
wsAssertConvAccessUpdate conv usr new n = do
  ...
  evtFrom e @?= usr
  evtData e @?= (EdConvAccessUpdate $ toConversationAccessDataResponse new)
...
mkConv cnvId creator selfRole otherMembers =
  FederatedGalley.RemoteConversation
    ...
    ( ConversationMetadata
        ...
        []
        ActivatedAccessRole
        (toAccessRoles ActivatedAccessRole)
